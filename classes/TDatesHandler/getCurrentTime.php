 ...
 * @subpackage         	: Get the current time.
 * @source             	: afw-examples/classes/TDatesHandler/getCurrentTime.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getCurrentTime
$currentTime = $objDates->getCurrentTime();
echo "Current Time: $currentTime<br>";  // Output: Current Time: (τρέχουσα ώρα)
