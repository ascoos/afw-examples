 ...
 * @subpackage         	: Subtract a specified number of days from a date.
 * @source             	: afw-examples/classes/TDatesHandler/subtractDays.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: subtractDays
$date = "2024-12-10";
$daysToSubtract = 5;
$newDate = $objDates->subtractDays($date, $daysToSubtract);
echo "New Date after subtracting $daysToSubtract days: $newDate<br>";  // Output: 2024-12-05
