 ...
 * @subpackage         	: Get the last day of the current year.
 * @source             	: afw-examples/classes/TDatesHandler/getLastDayOfCurrentYear.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getLastDayOfCurrentYear with optional format date
$lastDayOfCurrentYear = $objDates->getLastDayOfCurrentYear('l, Y-M-d');
echo "Last Day of Current Year: $lastDayOfCurrentYear<br>";  // Output: Tuesday, 2024-Dec-31
