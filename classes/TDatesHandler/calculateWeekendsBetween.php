 ...
 * @subpackage         	: Calculate the number of weekends between two dates.
 * @source             	: afw-examples/classes/TDatesHandler/calculateWeekendsBetween.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: calculateWeekendsBetween
$startDate = "2024-12-01";
$endDate = "2025-01-31";
$weekendsBetween = $objDates->calculateWeekendsBetween($startDate, $endDate);
echo "Weekends between $startDate and $endDate: $weekendsBetween weekends (days)<br>";  // Output: 17 weekends (days)
