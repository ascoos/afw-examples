 ...
 * @subpackage         	: Get the first day of the month for a given date.
 * @source             	: afw-examples/classes/TDatesHandler/getFirstDayOfMonth.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getFirstDayOfMonth
$date = "2024-12-10";
$firstDayOfMonth = $objDates->getFirstDayOfMonth($date);
echo "First Day of Month for $date: $firstDayOfMonth<br>";  // Output: 2024-12-01
