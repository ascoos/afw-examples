 ...
 * @subpackage         	: Get the last day of the month for a given date.
 * @source             	: afw-examples/classes/TDatesHandler/getLastDayOfMonth.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getLastDayOfMonth
$date = "2024-12-10";
$lastDayOfMonth = $objDates->getLastDayOfMonth($date);
echo "Last Day of Month for $date: $lastDayOfMonth<br>";  // Output: 2024-12-31
