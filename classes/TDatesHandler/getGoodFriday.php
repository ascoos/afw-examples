 ...
 * @subpackage         	: Calculate the date of Good Friday.
 * @source             	: afw-examples/classes/TDatesHandler/getGoodFriday.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getGoodFriday
$year = 2024;
$goodFriday = $objDates->getGoodFriday($year);
echo "Good Friday in $year: $goodFriday<br>";  // Output: Good Friday in 2024: YYYY-MM-DD
