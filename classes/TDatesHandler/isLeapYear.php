 ...
 * @subpackage         	: Check if a year is a leap year.
 * @source             	: afw-examples/classes/TDatesHandler/isLeapYear.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: isLeapYear
for ($year=2024; $year<=2040; $year++) {
    $isLeapYear = $objDates->isLeapYear($year);
    echo "Is year $year a leap year? " . ($isLeapYear ? '<b>Yes</b>' : 'No') . "<br>";  // Output: List    
}
