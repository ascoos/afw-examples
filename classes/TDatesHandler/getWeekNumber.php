 ...
 * @subpackage         	: Get the week number of the year for a given date.
 * @source             	: afw-examples/classes/TDatesHandler/getWeekNumber.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: getWeekNumber
$date = "2024-03-15";
$weekNumber = $objDates->getWeekNumber($date);
echo "Week number for $date: $weekNumber<br>";  // Output: Week number for 2024-03-15: XX
