 ...
 * @subpackage         	: Calculate the number of weeks between two dates.
 * @source             	: afw-examples/classes/TDatesHandler/calculateWeeksBetween.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
// Παράδειγμα χρήσης: calculateWeeksBetween
$startDate = "2024-12-01";
$endDate = "2025-02-01";
$weeksBetween = $objDates->calculateWeeksBetween($startDate, $endDate);
echo "Weeks between $startDate and $endDate: $weeksBetween weeks<br>";  // Output: 4 weeks
