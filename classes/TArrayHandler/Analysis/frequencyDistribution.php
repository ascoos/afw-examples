 ...
 * @subpackage         	: Calculates the frequency distribution of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/frequencyDistribution.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the frequency distribution
<GREEK> Υπολογισμός συχνότητας κατανομής
*/
$frequencyDistribution = $objArrayAnalysis->frequencyDistribution();
print_r($frequencyDistribution);
echo "<br><br>";
