 ...
 * @subpackage         	: Calculates the percentile of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/percentile.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$percentile = 0.25;
$valueAtPercentile = $objArrayAnalysis->percentile($percentile);
echo "Value in $percentile percentile: $valueAtPercentile<br>";
