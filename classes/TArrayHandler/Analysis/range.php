 ...
 * @subpackage         	: Calculates the range of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/range.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the range
<GREEK> Υπολογισμός εύρους
*/
$range = $objArrayAnalysis->range();
