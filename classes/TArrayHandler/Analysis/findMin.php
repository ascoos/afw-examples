 ...
 * @subpackage         	: Finds the minimum value in the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/findMin.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Find the minimum value
<GREEK> Εύρεση ελάχιστου στοιχείου
*/
$minValue = $objArrayAnalysis->findMin();
echo "Minimum Value: $minValue<br><br>";
