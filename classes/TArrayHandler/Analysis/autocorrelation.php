 ...
 * @subpackage         	: Calculates the autocorrelation of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/autocorrelation.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$lag = 2;
$autocorrelation = $objArrayAnalysis->autocorrelation($lag);
echo "Autocorrelation with lag $lag: $autocorrelation<br>";
