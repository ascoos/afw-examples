 ...
 * @subpackage         	: Calculates the moving average of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/movingAverage.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the moving average
<GREEK> Υπολογισμός κινητού μέσου όρου
*/
$movingAverage = $objArrayAnalysis->movingAverage(5);
print_r($movingAverage);
echo "<br><br>";
