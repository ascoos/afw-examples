 ...
 * @subpackage         	: Calculates the standard deviation of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/standardDeviation.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the standard deviation
<GREEK> Υπολογισμός τυπικής απόκλισης
*/
$stdDev = $objArrayAnalysis->standardDeviation();
echo "Standard Deviation: $stdDev<br><br>";
