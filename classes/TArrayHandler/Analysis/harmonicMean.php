 ...
 * @subpackage         	: Calculates the harmonic mean of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/harmonicMean.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$harmonicMean = $objArrayAnalysis->harmonicMean();
echo "Harmonic Mean: $harmonicMean<br>";
