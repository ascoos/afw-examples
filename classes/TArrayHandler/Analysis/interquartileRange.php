 ...
 * @subpackage         	: Calculates the interquartile range of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/interquartileRange.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$iqr = $objArrayAnalysis->interquartileRange();
echo "Interquartile Range: $iqr<br>";
