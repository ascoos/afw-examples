 ...
 * @subpackage         	: Groups the array elements based on a callback function.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/groupBy.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Group array by callback function
<GREEK> Ομαδοποίηση πίνακα βάσει callback συνάρτησης
*/
$groupedArray = $objArrayAnalysis->groupBy(fn($value) => $value % 3 == 0 ? 'divisible by 3' : 'not divisible by 3');
