 ...
 * @subpackage         	: Finds the maximum value in the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/findMax.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Find the maximum value
<GREEK> Εύρεση μέγιστου στοιχείου
*/
$maxValue = $objArrayAnalysis->findMax();
echo "Maximum Value: $maxValue<br><br>";
