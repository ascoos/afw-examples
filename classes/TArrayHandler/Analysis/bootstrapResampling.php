 ...
 * @subpackage         	: Generates bootstrap samples from the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/bootstrapResampling.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$bootstrapSamples = $objArrayAnalysis->bootstrapResampling(3); // Δημιουργία 3 bootstrap δειγμάτων
print_r($bootstrapSamples);
echo "<br>";
