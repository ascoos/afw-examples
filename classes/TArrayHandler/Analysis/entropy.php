 ...
 * @subpackage         	: Calculates the entropy of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/entropy.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the entropy
<GREEK> Υπολογισμός εντροπίας
*/
$entropy = $objArrayAnalysis->entropy();
echo "Entropy: $entropy<br><br>";
