 ...
 * @subpackage         	: Calculates the geometric mean of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/geometricMean.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$geometricMean = $objArrayAnalysis->geometricMean();
echo "Geometric Mean: $geometricMean<br>";
