 ...
 * @subpackage         	: Calculates the weighted average of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/weightedAverage.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the weighted average
<GREEK> Υπολογισμός σταθμισμένου μέσου όρου
*/
$weights = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 1, 1, 1, 1, 1];
$weightedAverage = $objArrayAnalysis->weightedAverage($weights);
echo "Weighted Average: $weightedAverage<br><br>";
