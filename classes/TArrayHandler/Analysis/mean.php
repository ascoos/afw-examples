 ...
 * @subpackage         	: Calculates the mean (average) of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/mean.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the mean
<GREEK> Υπολογισμός μέσου όρου
*/
$mean = $objArrayAnalysis->mean();
