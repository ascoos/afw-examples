 ...
 * @subpackage         	: Calculates the median of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/median.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the median
<GREEK> Υπολογισμός διαμέσου
*/
$median = $objArrayAnalysis->median();
echo "Median: $median<br><br>";
