 ...
 * @subpackage         	: Calculates the sum of squares of the array elements.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/sumOfSquares.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the sum of squares
<GREEK> Υπολογισμός αθροίσματος τετραγώνων
*/
$sumOfSquares = $objArrayAnalysis->sumOfSquares();
echo "Sum of Squares: $sumOfSquares<br><br>";
