 ...
 * @subpackage         	: Normalizes the array using Z-score normalization.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/zScoreNormalization.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$normalizedArray = $objArrayAnalysis->zScoreNormalization();
