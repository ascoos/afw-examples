 ...
 * @subpackage         	: Calculates the mode of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/mode.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Calculate the mode
<GREEK> Υπολογισμός τρόπου
*/
$mode = $objArrayAnalysis->mode();
echo "Mode: ";
print_r($mode);
echo "<br><br>";
