 ...
 * @subpackage         	: Calculates the kurtosis of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/kurtosis.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$kurtosis = $objArrayAnalysis->kurtosis();
echo "Kurtosis: $kurtosis<br>";
