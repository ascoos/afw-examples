 ...
 * @subpackage         	: Calculates the skewness of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/skewness.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$skewness = $objArrayAnalysis->skewness();
echo "Skewness: $skewness<br>";
