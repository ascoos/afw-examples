 ...
 * @subpackage         	: Automatically generates a report of basic statistical measures for the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/generateStatisticsReport.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Automatically generate a statistics report
<GREEK> Αυτόματη δημιουργία αναφοράς στατιστικών μέτρων
*/
$statsReport = $objArrayAnalysis->generateStatisticsReport();
print_r($statsReport);
