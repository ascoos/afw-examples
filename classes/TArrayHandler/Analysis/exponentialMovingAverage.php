 ...
 * @subpackage         	: Calculates the exponential moving average of the array.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/exponentialMovingAverage.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
$alpha = 0.5; // Συντελεστής εξομάλυνσης
$ema = $objArrayAnalysis->exponentialMovingAverage($alpha);
echo "Exponential moving average with alpha $alpha: ";
print_r($ema);
echo "<br>";
