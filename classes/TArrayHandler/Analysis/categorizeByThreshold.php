 ...
 * @subpackage         	: Categorizes the array based on a threshold.
 * @source             	: afw-examples/classes/TArrayHandler/Analysis/categorizeByThreshold.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/*
<ENGLISH> Categorize array by threshold
<GREEK> Κατηγοριοποίηση πίνακα βάσει ορίου
*/
$categorizedArray = $objArrayAnalysis->categorizeByThreshold(7);
print_r($categorizedArray);
echo "<br><br>";
